...
1. [Fork](https://github.com/quic-qrb-ros/qrb_ros_camera/fork) and clone the repository.
...
1. [Submit a pull request](https://github.com/quic-qrb-ros/qrb_ros_camera/pulls) from your branch to `main`.
